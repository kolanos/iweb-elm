...
Elm.Home.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = F2(function (address,model) {    return A2($Html.div,_U.list([]),_U.list([$Html.text("This is the home page")]));});
   ...
   return _elm.Home.values = {_op: _op,init: init,NoOp: NoOp,Show: Show,update: update,view: view};
};
...
Elm.Routes.make = function (_elm) {
   ...
   var encode = function (route) {
      ...
      switch (_p0.ctor)
      {case "Home": return "/";
         case "HostListingPage": return "/hosts";
         case "NewHostPage": return "/hosts/new";
         case "HostDetailPage": return A2($Basics._op["++"],"/hosts/",$Basics.toString(_p0._0));
         default: return "";}
   };
   ...
   var NewHostPage = {ctor: "NewHostPage"};
   var HostDetailPage = function (a) {    return {ctor: "HostDetailPage",_0: a};};
   var HostListingPage = {ctor: "HostListingPage"};
   var Home = {ctor: "Home"};
   var routeParsers = _U.list([A2($RouteParser.$static,Home,"/")
                              ,A2($RouteParser.$static,HostListingPage,"/hosts")
                              ,A2($RouteParser.$static,NewHostPage,"/hosts/new")
                              ,A4($RouteParser.dyn1,HostDetailPage,"/hosts/",$RouteParser.$int,"")]);
   ...
   return _elm.Routes.values = {_op: _op
                               ,Home: Home
                               ,HostListingPage: HostListingPage
                               ,HostDetailPage: HostDetailPage
                               ,NewHostPage: NewHostPage
...
Elm.ServerApi.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var encodeHost = function (a) {
      return A2($Json$Encode.encode,
      0,
      $Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "cpu",_1: $Json$Encode.$int(a.cpu)}
                                  ,{ctor: "_Tuple2",_0: "memory",_1: $Json$Encode.$int(a.memory)}
                                  ,{ctor: "_Tuple2",_0: "disk_space",_1: $Json$Encode.$int(a.disk_space)}
                                  ,{ctor: "_Tuple2",_0: "status",_1: $Json$Encode.string(a.status)}])));
   };
   var baseUrl = "http://api.iwebhires.com";
   var deleteHost = F2(function (id,action) {
      return $Effects.task(A2($Task.map,
      action,
      $Task.toMaybe(A2($Http.send,
      $Http.defaultSettings,
      {verb: "DELETE",url: A2($Basics._op["++"],baseUrl,A2($Basics._op["++"],"/hosts/",$Basics.toString(id))),body: $Http.empty,headers: _U.list([])}))));
   });
   var Host = F5(function (a,b,c,d,e) {    return {id: a,cpu: b,memory: c,disk_space: d,status: e};});
   var hostDecoder = A6($Json$Decode.object5,
   Host,
   A2($Json$Decode._op[":="],"id",$Json$Decode.$int),
   A2($Json$Decode._op[":="],"cpu",$Json$Decode.$int),
   A2($Json$Decode._op[":="],"memory",$Json$Decode.$int),
   A2($Json$Decode._op[":="],"disk_space",$Json$Decode.$int),
   A2($Json$Decode._op[":="],"status",$Json$Decode.string));
   var getHost = F2(function (id,action) {
      return $Effects.task(A2($Task.map,
      action,
      $Task.toMaybe(A2($Http.get,hostDecoder,A2($Basics._op["++"],baseUrl,A2($Basics._op["++"],"/hosts/",$Basics.toString(id)))))));
   });
   var createHost = F2(function (host,action) {
      return $Effects.task(A2($Task.map,
      action,
      ...
      $Http.defaultSettings,
      {verb: "POST"
      ,url: A2($Basics._op["++"],baseUrl,"/hosts")
      ,body: $Http.string(encodeHost(host))
      ,headers: _U.list([{ctor: "_Tuple2",_0: "Content-Type",_1: "application/json"}])})))));
   });
   var hostsDecoder = $Json$Decode.list(hostDecoder);
   var getHosts = function (action) {
      return $Effects.task(A2($Task.map,action,$Task.toMaybe(A2($Http.get,hostsDecoder,A2($Basics._op["++"],baseUrl,"/hosts")))));
   };
...
Elm.HostDetail = Elm.HostDetail || {};
Elm.HostDetail.make = function (_elm) {
   "use strict";
   _elm.HostDetail = _elm.HostDetail || {};
   if (_elm.HostDetail.values) return _elm.HostDetail.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("Create Host")]))
              ,A2($Html.form,
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([$Html$Attributes.$class("btn btn-default"),$Html$Attributes.type$("button"),A2($Html$Events.onClick,address,SaveHost)]),
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "GetHost": return {ctor: "_Tuple2",_0: model,_1: A2($ServerApi.getHost,_p0._0,ShowHost)};
         case "ShowHost": var _p1 = _p0._0;
           if (_p1.ctor === "Just") {
                 var _p2 = _p1._0;
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{id: $Maybe.Just(_p2.id),cpu: _p2.cpu,memory: _p2.memory,disk_space: _p2.disk_space,status: _p2.status})
                        ,_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2",_0: _U.update(model,{id: $Maybe.Nothing,cpu: 0,memory: 0,disk_space: 0,status: "ACTIVE"}),_1: $Effects.none};
              }
         case "SaveHost": return {ctor: "_Tuple2"
                                 ,_0: model
...
Elm.HostListing = Elm.HostListing || {};
Elm.HostListing.make = function (_elm) {
   "use strict";
   _elm.HostListing = _elm.HostListing || {};
   if (_elm.HostListing.values) return _elm.HostListing.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var HandleHostDeleted = function (a) {    return {ctor: "HandleHostDeleted",_0: a};};
   var DeleteHost = function (a) {    return {ctor: "DeleteHost",_0: a};};
   var hostRow = F2(function (address,host) {
      return A2($Html.tr,
      _U.list([]),
      _U.list([A2($Html.td,_U.list([]),_U.list([$Html.text($Basics.toString(host.cpu))]))
              ...
              _U.list([]),
              _U.list([A2($Html.button,
              _U.list([A2($Html$Events.onClick,address,DeleteHost(function (_) {    return _.id;}(host)))]),
              _U.list([$Html.text("Delete")]))]))]));
   });
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("Hosts")]))
              ,A2($Html.button,
              _U.list([$Html$Attributes.$class("pull-right btn btn-default"),$Routes.clickAttr($Routes.NewHostPage)]),
              _U.list([$Html.text("New Host")]))
              ,A2($Html.table,
              ...
              _U.list([A2($Html.thead,
                      ...
                      _U.list([A2($Html.tr,
                      _U.list([]),
                      _U.list([A2($Html.th,_U.list([]),_U.list([$Html.text("CPU")]))
                              ,A2($Html.th,_U.list([]),_U.list([$Html.text("Memory")]))
                              ,A2($Html.th,_U.list([]),_U.list([$Html.text("Disk Space")]))
                              ,A2($Html.th,_U.list([]),_U.list([$Html.text("Status")]))
                              ,A2($Html.th,_U.list([]),_U.list([]))]))]))
                      ,A2($Html.tbody,_U.list([]),A2($List.map,hostRow(address),model.hosts))]))]));
   });
   var HandleHostsRetrieved = function (a) {    return {ctor: "HandleHostsRetrieved",_0: a};};
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "Show": return {ctor: "_Tuple2",_0: model,_1: $ServerApi.getHosts(HandleHostsRetrieved)};
         case "HandleHostsRetrieved": return {ctor: "_Tuple2",_0: _U.update(model,{hosts: A2($Maybe.withDefault,_U.list([]),_p0._0)}),_1: $Effects.none};
         case "DeleteHost": return {ctor: "_Tuple2",_0: model,_1: A2($ServerApi.deleteHost,_p0._0,HandleHostDeleted)};
         default: return {ctor: "_Tuple2",_0: model,_1: $ServerApi.getHosts(HandleHostsRetrieved)};}
   });
   var Show = {ctor: "Show"};
   var Model = function (a) {    return {hosts: a};};
   var init = Model(_U.list([]));
   return _elm.HostListing.values = {_op: _op
                                    ,init: init
                                    ,view: view
                                    ,update: update
                                    ,Model: Model
                                    ,Show: Show
                                    ,HandleHostsRetrieved: HandleHostsRetrieved
                                    ,DeleteHost: DeleteHost
                                    ,HandleHostDeleted: HandleHostDeleted};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $HostDetail = Elm.HostDetail.make(_elm),
   $HostListing = Elm.HostListing.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var menu = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.a,$Routes.linkAttrs($Routes.Home),_U.list([$Html.text("iWeb")]))]))]))
              ,A2($Html.ul,
              _U.list([$Html$Attributes.$class("nav navbar-nav")]),
              _U.list([A2($Html.li,_U.list([]),_U.list([A2($Html.a,$Routes.linkAttrs($Routes.HostListingPage),_U.list([$Html.text("Hosts")]))]))]))]))]));
   });
   ...
   var HostDetailAction = function (a) {    return {ctor: "HostDetailAction",_0: a};};
   var HostListingAction = function (a) {    return {ctor: "HostListingAction",_0: a};};
   var mountRoute = F3(function (prevRoute,route,model) {
      var _p0 = route;
      switch (_p0.ctor)
      {case "Home": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "HostListingPage": return {ctor: "_Tuple2"
                                        ,_0: model
                                        ,_1: A2($Effects.map,HostListingAction,$ServerApi.getHosts($HostListing.HandleHostsRetrieved))};
         case "HostDetailPage": return {ctor: "_Tuple2",_0: model,_1: A2($Effects.map,HostDetailAction,A2($ServerApi.getHost,_p0._0,$HostDetail.ShowHost))};
         case "NewHostPage": return {ctor: "_Tuple2",_0: _U.update(model,{hostDetailModel: $HostDetail.init}),_1: $Effects.none};
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         ...
         case "HostListingAction": var _p6 = A2($HostListing.update,_p4._0,model.hostListingModel);
           var model$ = _p6._0;
           var effects = _p6._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{hostListingModel: model$}),_1: A2($Effects.map,HostListingAction,effects)};
         case "HostDetailAction": var _p7 = A2($HostDetail.update,_p4._0,model.hostDetailModel);
           var model$ = _p7._0;
           var effects = _p7._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{hostDetailModel: model$}),_1: A2($Effects.map,HostDetailAction,effects)};
   ...
   var contentView = F2(function (address,model) {
      ...
      {case "Home": return A2($Home.view,A2($Signal.forwardTo,address,HomeAction),model.homeModel);
         case "HostListingPage": return A2($HostListing.view,A2($Signal.forwardTo,address,HostListingAction),model.hostListingModel);
         case "HostDetailPage": return A2($HostDetail.view,A2($Signal.forwardTo,address,HostDetailAction),model.hostDetailModel);
         case "NewHostPage": return A2($HostDetail.view,A2($Signal.forwardTo,address,HostDetailAction),model.hostDetailModel);
         default: return $Html.text("No route specified");}
   });
   var view = F2(function (address,model) {
      return A2($Html.div,
   ...
   return _elm.Main.values = {_op: _op
                             ...
                             ,HostListingAction: HostListingAction
                             ,HostDetailAction: HostDetailAction
